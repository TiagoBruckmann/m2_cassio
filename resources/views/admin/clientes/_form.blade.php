...
<div class="form-group">
    ...
    <input type="integer" name="fone" value="{{ isset($registro->fone) ? $registro->fone : '' }}">
</div>
...
<div class="form-group">
    <label>Salario</label>
    <input type="numeric" name="vl_salario" value="{{ isset($registro->vl_salario) ? $registro->vl_salario : '' }}">
</div>
